...
def test_iqcloud_handler_multiple_recordings(iqcloud_handler_factory):
    ...
    iqcloud_handler.process_results()
    print(job.cells[0].data("result"))
    np.testing.assert_equal(
        job.cells[0].data("result"),
        np.array(
            [
                [
                    [-334, -343, -35, -35, 308, 305, 166],
                    [-341, -341, -33, -37, 308, 167, 167],
                    [-341, -342, -36, 308, 307, 166, 166],
                    [-341, -37, -34, 306, 308, 166, 167],
                ],
                [
                    [-60, -72, -353, -353, -137, -143, 234],
                    [-73, -73, -351, -352, -141, 233, 233],
                    [-77, -70, -353, -141, -141, 232, 233],
                    [-73, -353, -355, -141, -138, 233, 232],
                ],
            ]
        ),
    )
